    ...
    <div className="flex items-center space-x-2">
      ...
      <div>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center whitespace-nowrap font-semibold dark:text-white"
        >
      ...
      switch (entity.type) {
        ...
        case "text":
          return (
            <span
              key={idx}
              className="text-sm font-normal text-gray-500 dark:text-gray-200"
...
export const TweetMedia = ({ tweet }: { tweet: EnrichedTweet }) => {
  ...
  return (
    <div className="flex flex-1 items-center justify-center">
      ...
      {!tweet.video &&
        !tweet.photos &&
        // @ts-expect-error - La estructura del tweet no está completamente tipada
        tweet?.card?.binding_values?.thumbnail_image_large?.image_value.url && (
          <img
            src={
               // @ts-expect-error - La estructura anidada no está tipada correctamente
              tweet.card.binding_values.thumbnail_image_large.image_value.url
            }
